...
@Composable
fun Settings(userPreferences: UserPreferences, onExitAccount: () -> Unit) {
    Column(
        modifier = Modifier
            .fillMaxWidth()
            .fillMaxHeight()
        ...
        Button(onClick = { onExitAccount() }) {
            Text(text = stringResource(id = R.string.button_exit_account))
        }
    }
}